...
openssl req \
       ...
       -x509 -days 365 -out /vagrant/instance/saml/certs/saml.crt -subj "/C=US/ST=New York/L=New York/O=NYC Department of Records and Information Services/OU=IT/CN=saml.gpp.dev"
